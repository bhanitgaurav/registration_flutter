...
import 'package:registration_flutter/screens/views/input_otp_view.dart';
...
class InputOtpScreen extends ConsumerWidget {
  const InputOtpScreen(this.screen, {super.key});
